...
Revision ID: 236d02be0845
Revises: 
Create Date: 2022-12-21 11:36:05.148511
...
def upgrade():
    ...
    sa.Column('homeworls', sa.String(length=120), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('homeworls'),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('favs_p')
    op.drop_table('favs_ch')
    op.drop_table('user')
